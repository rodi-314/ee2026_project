...
module uiux(
    ...
    reg [6:0] kan_tile_1_x = 70, kan_tile_2_x = 34, kan_tile_3_x = 34, kan_tile_4_x = 70;
    reg [5:0] kan_tile_1_y = 33, kan_tile_2_y = 33, kan_tile_3_y = 49, kan_tile_4_y = 49;
    ...
    tile_designs kan_1 (clk, kan_1_index, x-kan_tile_1_x, y-kan_tile_1_y, kan_tile_1);
    tile_designs kan_2 (clk, kan_2_index, x-kan_tile_2_x, y-kan_tile_2_y, kan_tile_2);
    tile_designs kan_3 (clk, kan_3_index, x-kan_tile_3_x, y-kan_tile_3_y, kan_tile_3);
    tile_designs kan_4 (clk, kan_4_index, x-kan_tile_4_x, y-kan_tile_4_y, kan_tile_4);
    ...
    always @ (posedge clk25m) begin
        ...
        kan_1_index = player_hand[89:84];
        kan_2_index = player_hand[95:90];
        kan_3_index = player_hand[101:96];
        kan_4_index = player_hand[107:102];
        
        player_turn = (incoming_tile_index != 0);
        ...
        6'o10 : begin
            ...
            tile_12_x = tile_11_x + 8;
            tile_13_x =  tile_12_x + 8;
            kan_tile_3_x = tile_13_x + 8;
            
            if (x >= kan_tile_3_x && x < kan_tile_3_x + 8 && y >= tile_13_y && y < tile_13_y +13) begin
        ...
        6'o20 : begin
            ...
            tile_9_x = tile_8_x + 8;
            tile_10_x =  tile_9_x + 8;
            kan_tile_2_x = tile_10_x + 8;
            
            if (x >= kan_tile_2_x && x < kan_tile_2_x + 8 && y >= tile_10_y && y < tile_10_y +13) begin
                oled_data = kan_tile_2;
                end            
            
            tile_11_x = kan_tile_2_x + 12;
            tile_12_x = tile_11_x + 8;
            tile_13_x =  tile_12_x + 8;
        ...
        6'o30 : begin
            ...
            tile_2_x = tile_1_x + 8;
            tile_3_x =  tile_2_x + 8;
            kan_tile_3_x = tile_3_x + 8;
            
            if (x >= kan_tile_3_x && x < kan_tile_3_x + 8 && y >= tile_10_y && y < tile_10_y +13) begin
                oled_data = kan_tile_3;
                end            
            
            tile_9_x = tile_8_x + 8;
            tile_10_x =  tile_9_x + 8;
            kan_tile_2_x = tile_2_x + 8;
        ...
        6'o40 :begin 
            ...
            if (x >= kan_tile_1_x && x < kan_tile_1_x + 8 && y >= tile_13_y && y < tile_13_y +13) begin
                oled_data = kan_tile_1;
                end
            end
        ...
        if (player_turn) begin
            ...
            if (x >= incoming_tile_x && x < incoming_tile_x + 8 && y >= incoming_tile_y && y < incoming_tile_y +13) begin
                oled_data = incoming_tile_data;
                end
            end
        
        if (x >= tile_1_x && x< tile_1_x + 8 && y >= tile_1_y && y < tile_1_y +13) begin
            oled_data = sw[0] && clk1 ? 16'hFFFF: tile_data_1;
            end
            
        if (x >= tile_2_x && x< tile_2_x + 8 && y >= tile_2_y && y < tile_2_y +13) begin
            oled_data = sw[1] && clk1 ? 16'hFFFF: tile_data_2;
            end
            
        if (x >= tile_3_x && x< tile_3_x + 8 && y >= tile_3_y && y < tile_3_y +13) begin
            oled_data = sw[2] && clk1 ? 16'hFFFF:  tile_data_3;
            end
            
        if (x >= tile_4_x && x< tile_4_x + 8 && y >= tile_4_y && y < tile_4_y +13) begin
            oled_data = sw[3] && clk1 ? 16'hFFFF:  tile_data_4;
            end
            
        if (x >= tile_5_x && x< tile_5_x + 8 && y >= tile_5_y && y < tile_5_y +13) begin
            oled_data = sw[4] && clk1 ? 16'hFFFF:  tile_data_5;
            end
            
        if (x >= tile_6_x && x< tile_6_x + 8 && y >= tile_6_y && y < tile_6_y +13) begin
            oled_data = sw[5] && clk1 ? 16'hFFFF:  tile_data_6;
            end
            
        if (x >= tile_7_x && x< tile_7_x + 8 && y >= tile_7_y && y < tile_7_y +13) begin
            oled_data = sw[6] && clk1 ? 16'hFFFF:  tile_data_7;
            end
            
        if (x >= tile_8_x && x< tile_8_x + 8 && y >= tile_8_y && y < tile_8_y +13) begin
            oled_data = sw[7] && clk1 ? 16'hFFFF: tile_data_8;
            end
            
        if (x >= tile_9_x && x< tile_9_x + 8 && y >= tile_9_y && y < tile_9_y +13) begin
            oled_data = sw[8] && clk1 ? 16'hFFFF:  tile_data_9;
            end
            
        if (x >= tile_10_x && x< tile_10_x + 8 && y >= tile_10_y && y < tile_10_y +13) begin
            oled_data = sw[9] && clk1 ? 16'hFFFF: tile_data_10;
            end
            
        if (x >= tile_11_x && x< tile_11_x + 8 && y >= tile_11_y && y < tile_11_y +13) begin
            oled_data = sw[10] && clk1 ? 16'hFFFF:  tile_data_11;
            end
            
            
        if (x >= tile_12_x && x< tile_12_x + 8 && y >= tile_12_y && y < tile_12_y +13) begin
            oled_data = sw[11] && clk1 ? 16'hFFFF: tile_data_12;
            end
                
        if (x >= tile_13_x && x< tile_13_x + 8 && y >= tile_13_y && y < tile_13_y +13) begin
            oled_data = sw[12] && clk1 ? 16'hFFFF:  tile_data_13;
            end
            
        if (player_turn && x >= incoming_tile_x && x < incoming_tile_x + 8 && y >= incoming_tile_y && y < incoming_tile_y + 13) begin;
            oled_data = sw[13] && clk1 ? 16'hFFFF : incoming_tile_data;
            end
        
        if (sw[14]) oled_data[pixel_index] = discard[pixel_index];
